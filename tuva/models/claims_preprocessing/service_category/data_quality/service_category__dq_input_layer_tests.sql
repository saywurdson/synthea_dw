...
inner join {{ source('terminology', 'claim_type') }} b
...
, '{{ var('tuva_last_run')}}' as tuva_last_run
from {{ ref('service_category__stg_medical_claim') }} a
inner join {{ source('terminology', 'place_of_service') }} b
...
, '{{ var('tuva_last_run')}}' as tuva_last_run
from {{ ref('service_category__stg_medical_claim') }} a
inner join {{ source('terminology', 'bill_type') }} b
...
, '{{ var('tuva_last_run')}}' as tuva_last_run
from {{ ref('service_category__stg_medical_claim') }} a
inner join {{ source('terminology', 'revenue_center') }} b
...
, '{{ var('tuva_last_run')}}' as tuva_last_run
from {{ ref('service_category__stg_medical_claim') }} a
inner join {{ source('terminology', 'hcpcs_level_2') }} b
...
, '{{ var('tuva_last_run')}}' as tuva_last_run
from {{ ref('service_category__stg_medical_claim') }} a
inner join {{ source('terminology', 'ms_drg') }} b
...
, '{{ var('tuva_last_run')}}' as tuva_last_run
from {{ ref('service_category__stg_medical_claim') }} a
inner join {{ source('terminology', 'apr_drg') }} b
