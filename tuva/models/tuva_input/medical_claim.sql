    ...
    SELECT DISTINCT
        ...
        CASE
            WHEN (
                ...
                FROM {{ source('terminology', 'snomed_icd_10_map') }} AS map
...
FROM (
    ...
    FROM {{ source('json', 'Claim') }} c
    LEFT JOIN {{ source('json', 'ExplanationOfBenefit') }} e ON REPLACE(JSON_EXTRACT(c, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(e, '$.claim.reference'), '"Claim/', ''), '"', '')
    LEFT JOIN {{ source('json', 'Condition') }} co ON REPLACE(JSON_EXTRACT(co, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(c, '$.diagnosis[1].diagnosisReference.reference'), '"Condition/', ''), '"', '')
    LEFT JOIN {{ source('json', 'Procedure') }} p ON REPLACE(JSON_EXTRACT(p, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(c, '$.procedure[1].procedureReference.reference'), '"Procedure/', ''), '"', '')
    LEFT JOIN {{ source('terminology', 'snomed_icd_10_map') }} map ON REPLACE(JSON_EXTRACT(co, '$.code.coding[0].code'), '"', '') = map.referenced_component_id
    LEFT JOIN {{ source('reference', 'icd10cm_to_msdrg_v41') }} msdrg ON REPLACE(msdrg.ICD10, '.', '') = map.map_target
    LEFT JOIN {{ source('terminology', 'apr_drg') }} aprdrg ON aprdrg.mdc_code = msdrg.MDC
    LEFT JOIN {{ source('json', 'Practitioner') }} pr ON REPLACE(JSON_EXTRACT(pr, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(e, '$.provider.reference'), '"Practitioner/', ''), '"', '')
...
FROM (
    ...
    FROM {{ source('json', 'Claim') }} c
    LEFT JOIN {{ source('json', 'ExplanationOfBenefit') }} e ON REPLACE(JSON_EXTRACT(c, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(e, '$.claim.reference'), '"Claim/', ''), '"', '')
    LEFT JOIN {{ source('json', 'Condition') }} co ON REPLACE(JSON_EXTRACT(co, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(c, '$.diagnosis[2].diagnosisReference.reference'), '"Condition/', ''), '"', '')
    LEFT JOIN {{ source('json', 'Procedure') }} p ON REPLACE(JSON_EXTRACT(p, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(c, '$.procedure[2].procedureReference.reference'), '"Procedure/', ''), '"', '')
    LEFT JOIN {{ source('terminology', 'snomed_icd_10_map') }} map ON REPLACE(JSON_EXTRACT(co, '$.code.coding[0].code'), '"', '') = map.referenced_component_id
    LEFT JOIN {{ source('reference', 'icd10cm_to_msdrg_v41') }} msdrg ON REPLACE(msdrg.ICD10, '.', '') = map.map_target
    LEFT JOIN {{ source('terminology', 'apr_drg') }} aprdrg ON aprdrg.mdc_code = msdrg.MDC
    LEFT JOIN {{ source('json', 'Practitioner') }} pr ON REPLACE(JSON_EXTRACT(pr, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(e, '$.provider.reference'), '"Practitioner/', ''), '"', '')
...
FROM (
    ...
    FROM {{ source('json', 'Claim') }} c
    LEFT JOIN {{ source('json', 'ExplanationOfBenefit') }} e ON REPLACE(JSON_EXTRACT(c, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(e, '$.claim.reference'), '"Claim/', ''), '"', '')
    LEFT JOIN {{ source('json', 'Condition') }} co ON REPLACE(JSON_EXTRACT(co, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(c, '$.diagnosis[3].diagnosisReference.reference'), '"Condition/', ''), '"', '')
    LEFT JOIN {{ source('json', 'Procedure') }} p ON REPLACE(JSON_EXTRACT(p, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(c, '$.procedure[3].procedureReference.reference'), '"Procedure/', ''), '"', '')
    LEFT JOIN {{ source('terminology', 'snomed_icd_10_map') }} map ON REPLACE(JSON_EXTRACT(co, '$.code.coding[0].code'), '"', '') = map.referenced_component_id
    LEFT JOIN {{ source('reference', 'icd10cm_to_msdrg_v41') }} msdrg ON REPLACE(msdrg.ICD10, '.', '') = map.map_target
    LEFT JOIN {{ source('terminology', 'apr_drg') }} aprdrg ON aprdrg.mdc_code = msdrg.MDC
    LEFT JOIN {{ source('json', 'Practitioner') }} pr ON REPLACE(JSON_EXTRACT(pr, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(e, '$.provider.reference'), '"Practitioner/', ''), '"', '')
...
FROM (
    ...
    FROM {{ source('json', 'Claim') }} c
    LEFT JOIN {{ source('json', 'ExplanationOfBenefit') }} e ON REPLACE(JSON_EXTRACT(c, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(e, '$.claim.reference'), '"Claim/', ''), '"', '')
    LEFT JOIN {{ source('json', 'Condition') }} co ON REPLACE(JSON_EXTRACT(co, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(c, '$.diagnosis[4].diagnosisReference.reference'), '"Condition/', ''), '"', '')
    LEFT JOIN {{ source('json', 'Procedure') }} p ON REPLACE(JSON_EXTRACT(p, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(c, '$.procedure[4].procedureReference.reference'), '"Procedure/', ''), '"', '')
    LEFT JOIN {{ source('terminology', 'snomed_icd_10_map') }} map ON REPLACE(JSON_EXTRACT(co, '$.code.coding[0].code'), '"', '') = map.referenced_component_id
    LEFT JOIN {{ source('reference', 'icd10cm_to_msdrg_v41') }} msdrg ON REPLACE(msdrg.ICD10, '.', '') = map.map_target
    LEFT JOIN {{ source('terminology', 'apr_drg') }} aprdrg ON aprdrg.mdc_code = msdrg.MDC
    LEFT JOIN {{ source('json', 'Practitioner') }} pr ON REPLACE(JSON_EXTRACT(pr, '$.id'), '"', '') = REPLACE(REPLACE(JSON_EXTRACT(e, '$.provider.reference'), '"Practitioner/', ''), '"', '')
