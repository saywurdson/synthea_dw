...
FROM (
    ...
    LEFT JOIN {{ source('vocabulary', 'drug_strength') }} ds ON REPLACE(JSON_EXTRACT(c, '$.item[0].productOrService.coding[0].code'), '"', '') = ds.drug_concept_id
