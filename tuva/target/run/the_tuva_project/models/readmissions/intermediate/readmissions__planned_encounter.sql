  ...
  create view "synthea"."readmissions"."_int_planned_encounter__dbt_tmp" as (
...
select * , '2024-06-01 22:50:20.459372+00:00' as tuva_last_run from always_planned_px
union distinct
select *, '2024-06-01 22:50:20.459372+00:00' as tuva_last_run from always_planned_dx
union distinct
select *, '2024-06-01 22:50:20.459372+00:00' as tuva_last_run from potentially_planned_that_are_actually_planned
  );
