    ...
    create  table
      "synthea"."hcc_suspecting"."_int_patient_hcc_history__dbt_tmp"
...
with all_conditions as (
    ...
    select
        ...
        , hcc_code
        , hcc_description
    from "synthea"."hcc_suspecting"."_int_all_conditions"
...
, add_flag as (
    ...
    select
        ...
        , case
            when extract(year from hcc_billed.last_billed) = extract(year from now() )
            then 1
            else 0
